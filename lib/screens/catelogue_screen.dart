...
class CatelogueScreen extends StatelessWidget {
  const CatelogueScreen({Key? key, required this.sortBy}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> _articlesStream = FirebaseFirestore.instance
        ...
        .where('category', isEqualTo: '$sortBy News')
      ...
      body: Container(
        ...
        child: Scrollbar(
          child: StreamBuilder(
            ...
            builder:
                (BuildContext context, AsyncSnapshot<QuerySnapshot> articles) {
